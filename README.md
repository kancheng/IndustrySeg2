# <img src="https://github.com/NickSwardh/YoloDotNet/assets/35733515/994287a9-556c-495f-8acf-1acae8d64ac0" height=24> Industrial Product Surface Defect Detection System - YoloDotNet v4.0

> Industrial Product Surface Defect Detection System & Production Line Inspection Simulation

## Project Overview

This project demonstrates industrial quality inspection systems using YOLO-based object detection and segmentation.

### Industrial Defect Detection System

![Industrial Defect Detection System](./idsys-demo.gif)

**Industrial Product Surface Defect Detection System** - A defect detection system for industrial products using the **SD-saliency-900** dataset, trained with YOLO models. Built on **YoloDotNet** framework.

**SD-saliency-900**: Saliency detection for strip steel surface defects using multiple constraints and improved texture features.

### Production Line Simulation

![Production Line Simulation](./line-demo.gif)

**Production Line Inspection Simulation** - A Python-based simulation demonstrating real-time machine inspection of components on an actual production line.
...
## 🏭 Industrial Inspection with GUI

**IndustrySegmentationDemo** is a complete WPF-based graphical interface application designed for industrial quality inspection using semantic segmentation. It provides an intuitive, user-friendly interface for batch processing and real-time result visualization.

![Industrial Inspection Demo](./demo.gif)

### Key Features:

- **🎨 Full Graphical Interface** - Easy-to-use WPF application with no command-line required
- **📁 Single File & Batch Processing** - Process individual images or entire directories
- **⚙️ Real-time Parameter Adjustment** - Tune confidence, pixel confidence, and IoU thresholds on the fly
- **🖼️ Live Result Preview** - View detection results with segmentation masks, bounding boxes, and labels in real-time
- **📊 Statistics Dashboard** - Track total processed, NG (defect detected), and OK (no defect) counts
- **📈 Progress Tracking** - Monitor batch processing progress with visual progress bar
- **🔄 Image Navigation** - Browse through multiple processed images with previous/next buttons
- **📝 Detailed Logging** - Comprehensive operation logs with timestamps
- **💾 Automatic Result Saving** - Results automatically saved with NG/OK suffix for easy identification

### Use Cases:

Perfect for quality control in manufacturing, defect detection, and automated inspection workflows where you need:
- Visual feedback during processing
- Easy parameter tuning without code changes
- Batch processing capabilities
- Clear pass/fail classification (NG/OK)

The demo is located at [`Demo/IndustrySegmentationDemo`](./Demo/IndustrySegmentationDemo) and includes comprehensive documentation in both English and Chinese.
